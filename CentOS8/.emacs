...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (plantuml-mode markdown-toc markdown-mode rainbow-mode fill-column-indicator git-timemachine flycheck undo-tree org-download yaml-mode google-translate po-mode json-mode palette gitconfig persistent-scratch spaceline zenburn-theme use-package powerline pdf-tools org-bullets org magit htmlize diminish)))
...
(setq org-capture-templates
    ...
    ("m" "Meetings" entry (file "~/Documents/MyOrgs/inbox.org")
